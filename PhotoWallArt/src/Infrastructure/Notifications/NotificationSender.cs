...
using PhotoWallArt.Shared.Notifications;
using static PhotoWallArt.Shared.Notifications.NotificationConstants;

namespace PhotoWallArt.Infrastructure.Notifications;
